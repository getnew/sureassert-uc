...
public class SAUCNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(SAUCBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(SAUCBuilder.BUILDER_ID);
