 ...
 * @author Pete Gieser
 * @since 1.0
 * @version $Id: ExceptionUtils.java 904562 2010-01-29 17:12:02Z bayard $
 */
public class ExceptionUtils {
     ...
     */
	@NamedInstance(name="ExceptionUtils/f1")
	...
	@NamedInstance(name="ExceptionUtils/f2")
     ...
     */
    @Exemplars(set={
    @Exemplar(args="new java/lang/Exception('msg')", //
    		expect="#(retval,0).equals('java.lang.Exception: msg')"),
