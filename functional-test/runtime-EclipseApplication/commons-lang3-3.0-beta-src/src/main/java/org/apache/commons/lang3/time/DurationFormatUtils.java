 ...
 * @since 2.1
 * @version $Id: DurationFormatUtils.java 889219 2009-12-10 12:02:50Z bayard $
 */
public class DurationFormatUtils {      
     ...
     */
    @Exemplar(args={"5000123982623l", "false", "false"})
     ...
     * @return the time as a String
     */
    @Exemplar(args={"10l", "50000003l", "'HH:mm:ss'", "true", "java/util/TimeZone.getDefault()"})
