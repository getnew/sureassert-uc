 ...
 * 
 * @since 3.0
 * @version $Id: EventUtils.java 967237 2010-07-23 20:08:57Z mbenson $
 */
public class EventUtils {

    /**
     * Adds an event listener to the specified source. This looks for an "add"
     * method corresponding to the event type (addActionListener, for example).
     * 
     ...
     * @param eventSource the object which is generating events (JButton, JList,
     *            etc.)
     ...
     *            interface (if none specified, all will be supported)
     */
