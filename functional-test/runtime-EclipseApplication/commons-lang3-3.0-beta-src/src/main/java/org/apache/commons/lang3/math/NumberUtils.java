...
public class NumberUtils {
     ...
     */
    @Exemplars(set = { @Exemplar(args = "'52EE5'", expect = "false"), //
            @Exemplar(args = "'E5'", expect = "false"), //
            @Exemplar(args = "'0x'", expect = "false"), //
            @Exemplar(args = "'5E4.3'", expect = "false"), //
            @Exemplar(args = "'.'", expect = "false") })
