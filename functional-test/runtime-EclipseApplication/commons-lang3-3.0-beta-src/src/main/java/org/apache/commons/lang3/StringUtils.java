 ...
 */
//@Immutable
@HasJUnit(jUnitClassNames={"org.apache.commons.lang3.StringUtilsTest", "org.apache.commons.lang3.StringUtilsSubstringTest"})
public class StringUtils {
     ...
     */
    @Exemplar(args={"'test'","a:'test1','test'"}, expect="")
     ...
     */
    @Exemplars(set={
    		@Exemplar(args={"null", "13"}, expect="null"),
    		@Exemplar(args={"''", "-6"}, expect="''"), 
    		@Exemplar(args={"'abc'", "0"}, expect="'abc'"),
    		@Exemplar(args={"'abc'", "2"}, expect="'c'"),
    		@Exemplar(args={"'abc'", "4"}, expect="''"),
    		@Exemplar(args={"'abc'", "-2"}, expect="'bc'"),
    		@Exemplar(args={"'abc'", "-4"}, expect="'abc'")
    })
